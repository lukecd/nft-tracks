...
class NearConfig extends currency_1.default {
    ...
    sendTx(data) {
        return __awaiter(this, void 0, void 0, function* () {
            data;
            const res = yield (yield this.getProvider()).sendTransaction(data);
    ...
    createTx(amount, to, _fee) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const actions = [transactions_2.actionCreators.transfer(new bn_js_1.default(new bignumber_js_1.default(amount).toFixed().toString()))];
            if (!this.address)
                throw new Error("Address is undefined - you might be missing a wallet, or have not run bundlr.ready()");
            const tx = (0, transactions_2.createTransaction)(this.address, this.keyPair.getPublicKey(), to, nonce, actions, recentBlockHash);
