...
function getCurrency(bundlr, currency, wallet, url, providerUrl, contractAddress, opts) {
    switch (currency) {
        ...
        case "algorand": {
            return new algorand_1.default({ bundlr, name: "algorand", ticker: "ALGO", providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://algoexplorerapi.io", wallet, opts });
        }
        case "aptos": {
