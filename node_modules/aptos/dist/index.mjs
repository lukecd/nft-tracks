...
var IndexerClient = class {
  ...
  async getOwnedTokens(ownerAddress, extraArgs) {
    ...
    const graphqlQuery = {
      ...
      variables: { address, offset: (_a = extraArgs == null ? void 0 : extraArgs.options) == null ? void 0 : _a.offset, limit: (_b = extraArgs == null ? void 0 : extraArgs.options) == null ? void 0 : _b.limit }
    };
    return this.queryIndexer(graphqlQuery);
  }
